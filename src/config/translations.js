...
export const translations = {
  en: {
    ...
    patientsPending: "Grouped follow-up workload (illustrative)",
    scheduledTomorrow: "Scheduled: Tomorrow",
    viewAllPatients: "View All Patients",
    viewAllTasks: "View All Tasks",
    dischargeShareLow: "Illustrative share — connect live data",
    dischargeShareMedium: "Illustrative share — connect live data",
    dischargeShareHigh: "Illustrative share — connect live data",
    ...
    realtimeAlertTitle: "Readmission Alert",
    realtimeAlertBody: "{name} scored {score} — {tier} Risk. Review immediately.",
    wsConnected: "Live alerts connected",
    wsDisconnected: "Live alerts disconnected",
    wsReconnecting: "Reconnecting to live alerts…",
    taskAssignedBody: "A new task has been assigned to you.",
    changesSynced: "Changes synced",
    changesSyncedBody: "Your offline changes have been uploaded successfully.",

    // Offline queue
    offlineQueuePending: "Changes pending sync",
    offlineQueuePendingBody: "{count} change(s) will upload when online.",
    syncingChanges: "Syncing changes…",
    syncComplete: "Sync complete",
    offlineModeActive: "Offline mode — using cached data",
    offlinePredictionNote: "Prediction generated by on-device rules engine (offline).",
    cacheAge: "Cached {ago}",

    // Protocol guide navigation
    protocolGuide: "Protocol Guide",
    protocolGuideSubtitle: "How TRIP works — for every role",
  },
  ...
  sw: {
    ...
    patientsPending: "Kundi la ufuatiliaji (mfano wa picha)",
    scheduledTomorrow: "Imepangwa: Kesho",
    viewAllPatients: "Tazama Wagonjwa Wote",
    viewAllTasks: "Tazama Kazi Zote",
    dischargeShareLow: "Sehemu ya mfano — unganisha data hai",
    dischargeShareMedium: "Sehemu ya mfano — unganisha data hai",
    dischargeShareHigh: "Sehemu ya mfano — unganisha data hai",
    ...
    // Arifa za wakati halisi za WebSocket
    realtimeAlertTitle: "Tahadhari ya Kurudi Hospitali",
    realtimeAlertBody: "{name} amepata alama {score} — Hatari {tier}. Kagua mara moja.",
    wsConnected: "Arifa za moja kwa moja zimeunganishwa",
    wsDisconnected: "Arifa za moja kwa moja zimekatika",
    wsReconnecting: "Inaunganika tena kwa arifa za moja kwa moja…",
    taskAssignedBody: "Kazi mpya imekabidhiwa kwako.",
    changesSynced: "Mabadiliko yamesawazishwa",
    changesSyncedBody: "Mabadiliko yako ya bila mtandao yamepakiwa kwa mafanikio.",

    // Foleni ya bila mtandao
    offlineQueuePending: "Mabadiliko yanayosubiri kusawazishwa",
    offlineQueuePendingBody: "Mabadiliko {count} yatapakiwa mtandaoni ukirudi hewani.",
    syncingChanges: "Inasawazisha mabadiliko…",
    syncComplete: "Usawazishaji umekamilika",
    offlineModeActive: "Hali ya bila mtandao — inatumia data iliyohifadhiwa",
    offlinePredictionNote: "Utabiri ulizalishwa na injini ya sheria za ndani (bila mtandao).",
    cacheAge: "Ilihifadhiwa {ago}",

    // Urambazaji wa mwongozo wa itifaki
    protocolGuide: "Mwongozo wa Itifaki",
    protocolGuideSubtitle: "Jinsi TRIP inavyofanya kazi — kwa kila wajibu",
  },
};
